...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // set upper and lower bounds for steering angle
  for (i = delta_start; i < a_start; i++) {
      vars_lowerbound[i] = -0.436332 * Lf; // -25 degrees
      vars_upperbound[i] =  0.436332 * Lf; //  25 degrees
  }
  
  // set upper and lowers bounds for acceleration
  ...
  // set initial upper and lower bound for constraints
